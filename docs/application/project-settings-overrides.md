...
The c144163 packaged artifact was driven through the approved hidden desktop route. Project creation, Light override, Global defaults, reset-to-global, same-profile persistence, and schema-version 2 ownership restore were verified at 1480×940 across fresh process/desktop lifecycles. A fresh a1bb583 artifact also verified plain Settings filtering, no-match copy, the anchored regex builder surface, palette discovery, and corrected Funny-level routing to the filtered section. Valid regex matches, invalid-record omission, schema-version 1 compatibility, timeout paths, keyboard-only traversal, accessibility variants, tests, lint, type checking, installer execution, and screenshots remain unverified.
