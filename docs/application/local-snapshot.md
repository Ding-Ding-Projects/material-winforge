...
New snapshots use state schema version 2 and include a versioned, bounded project-settings ownership block. Existing schema-version 1 snapshots remain readable and never erase current ownership records.
