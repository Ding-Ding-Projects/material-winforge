...
export default function SiteShell({ assetBase }: { assetBase: string }) {
  ...
  useEffect(() => {
    const handler = (event: KeyboardEvent) => {
      ...
      if (event.key === "Escape") { setPaletteOpen(false); setBuilderOpen(false); setNotificationOpen(false); setNotificationBuilderOpen(false); setSettingsHistoryOpen(false); setSettingsHistoryBuilderOpen(false); setSettingsRestoreId(null); }
    };
